...
export function GlobalAIScreen({ token }: GlobalAIScreenProps) {
  ...
  const handleClear = async () => {
    ...
    try {
      ...
      setChatKey((k) => k + 1) // remount chat to reset state
    } catch { /* non-fatal */ }
    ...
    <div className="flex h-full flex-col bg-background">
      ...
      <div className="shrink-0 flex items-center justify-between px-4 pb-3 pt-4 border-b border-border safe-area-pt">
        <div className="flex items-center gap-3">
          <div className="h-9 w-9 rounded-xl bg-gradient-to-br from-primary to-emerald-400 flex items-center justify-center shadow-lg shadow-primary/30">
      ...
      {/* Chat — remounts on clear via key */}
      <AiChatTab
        key={chatKey}
        token={token}
        mode="global"
        ...
        welcomeMessage="Hi! I'm Tickr, your AI market assistant. Ask me about stocks, news, market trends, or anything about Indian equity markets. I have access to the latest news and real-time data."
